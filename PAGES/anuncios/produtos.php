        ...
        <header class="activities-list flex">            
            <?php 
                if(isset($_GET['perfil'])){
                    ...
                    if(isset($_GET['categoriafiltrada'])){?>
                        <button style="cursor: pointer;" onclick="location.href='../home/home.php?categoriafiltrada=<?php echo $categoriafiltrada;?>'"><img src="../../ASSETS/backButtonDark.svg" alt="back-button" style ="width: 1.6rem;"></button>
                        <?php
                    }else{?>
