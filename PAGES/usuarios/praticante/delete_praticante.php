<?php
    ...
    $deletePraticante = "DELETE FROM TABPRA WHERE TABUSU_Codigo = $codigo";
    $queryDeletePraticante = $mysqli->query($deletePraticante) or die("Falha na execução do código sql" . $mysqli->error);  
